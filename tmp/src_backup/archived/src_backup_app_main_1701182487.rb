...
def render_grid(args)
  for x in 0...args.state.grid_height do
    for y in 0...args.state.grid_width do
    end
    end
  end
  render_cube(args, 0, 0)
  render_cube(args, 1, 1)
...
def render_cube(args, x, y)
  ...
  grid_y = 0
  box_size = 30
  args.outputs.solids << [grid_x + (x * box_size), (720 - grid_y) - (y * box_size + box_size), box_size, box_size, 255, 0, 0, 255]
end
